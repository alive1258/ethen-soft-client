...
import { useCreateTermsConditionMutation } from "@/redux/api/termsConditionsApi";
...
const CreateTermsCondition = () => {
  ...
  const [createTermsCondition, { isLoading }] =
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (res?.success === true) {
        reset();
        router.back();
        toast.success("TermsCondition added successfully!", {
