...
const About = () => {
  return (
    <>
      ...
      >
        <div
          className="container py-12 flex items-center bg-no-repeat gap-5"
          style={{
            backgroundImage: "url(/assets/images/about/Ellipse.png)",
          }}
        >
          <div className="w-full">
            <p className="uppercase text-primary-base text-lg font-medium pb-4">
              ABOUT ETHENSOFT
            </p>
            <h1 className="text-[32px] font-semibold pb-6">
              We design, develop, implement and support{" "}
              <span className="text-primary-base">IT Systems</span>
            </h1>
            <p className="text-lg font-light text-black-base pb-8">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua.
              exercitation ullamco laboris nisi ut aliquip ex ea commodo
              consequat aute irure dolor in reprehenderit velit.
            </p>
            <p className="text-black-base text-lg font-medium border-none border-l-2 border-l-primary-base">
